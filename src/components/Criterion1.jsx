  ...
  return (
    ...
    <div>
      ...
      {showForm && (
        ...
        <DocumentAttachment documents={['Programme/ Curriculum/ Syllabus of the New Course', 'Minutes of BOS/ Academic Council Meeting with approvals for these courses', 'Data template on the courses having the focus on Employability/Entrepreneurship/ Skill Development','Any other related additional information']} />        </div>
      )}
    
      <h3>1.2.2  Programmes in which Choice Based Credit System (CBCS)/elective course system has been implemented during the year ( Nil )</h3>
     <DynamicTable headers={['Names of the programs adopting CBCS', 'Names of the programs adopting ECS', 'Copy of the Data Template','Relevant Supporting Documents']}></DynamicTable>
     <DocumentAttachment documents={['Programme/ Curriculum/ Syllabus of the Course', 'Data template on the courses having the focus on CBCS/ECS', 'Any other related additional information']} />
    </div>
      <h2>Key Indicator – 1.3: Curriculum Enrichment</h2>
    <button onClick={toggleForm}>{showForm ? 'Hide Form' : 'Show Form'}</button>
    {showForm && (
      <>
      <h3>1.3.1 Departmental cross cutting issues relevant to Gender, Environment and Sustainability, Human Values and Professional Ethics into the Curriculum</h3>
      <p>Write description in maximum of 500 words</p>
      <textarea/>
      <h4>File Description(Upload)/ Documents to Attach</h4>
     <DocumentAttachment documents={['Any additional information', 'Upload the list and description of the courses which address the Gender, Environment and Sustainability, Human Values and Professional Ethics into the Curriculum']} />
     
     <h3>1.3.2 Value-added courses imparting transferable and life skills offered during the academic year</h3>
     <DynamicTable headers={['Academic Year','Name(s) of the New Value added course with 30 or more contact hours','Number of times the course is offered in the same year']}></DynamicTable>
     <DocumentAttachment documents={['Programme/ Curriculum/ Syllabus of the Course','Any other related additional information']}></DocumentAttachment>

     <h3>1.3.3  Students enrolled in the courses under 1.3.2 above</h3>
     <DynamicTable headers={['Academic Year','Total number of students admitted','Number of students completed the course']}></DynamicTable>
     <DocumentAttachment documents={['Admitted List of the students','Attendance & Assessment Reports','Class work Time tables','Lesson/Teaching Plan  Schedules','List of Faculty members involved in the course program(both departmental/outsourcing)','Any other related additional information']}></DocumentAttachment>

     <h3>1.3.4 Students undertaking field projects / internships during the academic year</h3>
     <DynamicTable headers={['Academic Year','Name of the programme','Number of students undertaking the field projects','Number of students undertaking the research  projects']}></DynamicTable>
     <DocumentAttachment documents={['Admitted List of the students','Attendance & Assessment Reports','Class work Time tables','Lesson/Teaching Plan  Schedules','List of Faculty members involved in the course program(both departmental/outsourcing)','Any other related additional information']}></DocumentAttachment>
      </>
    ...
    {showForm && (
      <>
       <div>
      <h3>1.4.1 Structured feedback for design and review of syllabus -- Semester wise feedback received from:</h3>
    ...
    <DocumentAttachment documents={['URL for stakeholder feedback report','Action taken report of the University on feedback report as stated in the minutes of the Governing Council, Syndicate, Board of Management (Upload)','Any additional information (Upload)']}></DocumentAttachment>

    <div>
      <h3>1.4.2 Feedback processes of the institution may be classified as follows:(opt any one)</h3>
      <form>
        <input
          type="radio"
          id="optionA"
          ...
          checked={selectedOption === 'Feedback collected, analysed and action taken and feedback available on website'}
          onChange={handleChange}
        />
        <label htmlFor="optionA">Feedback collected, analysed and action taken and feedback available on website</label>
        <br />
        <input
          type="radio"
          id="optionB"
          ...
          checked={selectedOption === 'Feedback collected, analysed and action has been taken'}
          onChange={handleChange}
        />
        <label htmlFor="optionB">Feedback collected, analysed and action has been taken</label>
        <br />
        <input
          type="radio"
          id="optionC"
    ...
    <DocumentAttachment documents={['Upload Stakeholder feedback report','Action taken report of the university on it asstated in the minutes of the Governing Council,Syndicate, Board of Management','Upload any additional information','URL for feedback report']}></DocumentAttachment>
      </>
    )}
    </>
  )
